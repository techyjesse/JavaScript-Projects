...
function get_todos() {
    /*This creates an array of tass that are inputed*/
    var todos = new Array;
    /*This pulls the task that was saved in the web browser memory */
    var todos_str = localStorage.getItem('todo');
    /*If the input is not null then JSON.parse will communicate with the web browser to make the tak a JS object */
    if (todos_str !== null) {
...
/*this will keep the inputs displayed permaently on the screen */
show();
...
function remove() {
    ...
    todos.splice(id, 1);
    localStorage.setItem("todo", JSON.stringify(todos));
    /*This looks in show to display a removed item on the screen */
    show();
