...
function placeXOrO(squareNumber) {
    //This condition ensures a swuare hasn't been selected already.
    ...
    if (!selectedSquares.some(element => element.includes(squareNumber))) {
        ...
        if (activePlayer === 'X') {
            //If player is equal to x, thex.png is placed in HTNML.
            select.style.backgroundImage = 'url("images/x.png")';
            //Active player may only be X or O so, if not X it must be O.
        } else {
            //If activePlayer is equal to O, the o.pnmg is placed in HTML
        ...
        checkWinConditions();
        //This condition is for changing the player.
        if (activePlayer === 'X') {
        ...
        if(activePlayer === 'O') {
            ...
            disableClick();
            //This function waits 1 second before computer plafes image and enables click.
    ...
    function computersTurn() {
        ...
        let pickASquare;
        //This condition allows our while loop to keep trying if a swquare is selected already.
        while(!success) {
...
function checkWinConditions() {
    ...
    //This condition checks for a tie. If none of the above conditions register and 9 squares are selected the code executes.
        ...
        //This function plays the tie game sound. (Nooooooo!)
        audio('./media/tie.mp3');
...
function disableClick() {
    ...
    //This makes our body clickab le again after 1 second.
...
//This function utilizes html cancas to draw win lines.
...
//This line accesses our html canvas element.
    ...
    //This line indicates where the start of a lines y axis is.
        y1 = coordY1,
        //This line indicateas where the end of a lines x axis is.
        x2 = coordX2,
        //This line indicates where the end of a lines y acis is.
        y2 = coordY2,
